...
vendorFiles=(weever.js vendor/custom.modernizr.js jscolor/jscolor.js foundation/foundation.js foundation/foundation.*.js account.js fileuploader.js theme.js list.js)

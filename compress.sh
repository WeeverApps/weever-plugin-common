...
vendorFiles=(weever.js vendor/modernizr.js jscolor/jscolor.js foundation/foundation.js foundation/foundation.*.js account.js fileuploader.js vendor/jquery.iframe-transport.js list.js vendor/jquery.cookie.js)

...
(function($){
    wxApp.JoomlaProximitySubTab = wxApp.SubTab.extend({
        default_icon_id: 27,
        allowedLayouts: ['list'],
        ...
        defaults: function() {
            return _.extend( {}, wxApp.SubTab.prototype.defaults(), {
                ...
                icon: 'e101',
                icon_id: 27,
                type: 'JoomlaProximity',
                content: 'html',
                layout: 'list',
                config: { url: '', gps: '1', geotag: '1', subtab_name: 'JoomlaProximitySubTab' },
                ...
                helpBody:   '<p><b>Adding Joomla content to your app</b></p>' +
                            ...
                            '<p>The difference is how the geotagged content displays.  &ldquo;Nearby&rdquo; lists articles or K2 items in order of nearest-distance instead of creating a custom Google map.</p>' +                            '<p><b>Maps</b></p>' +

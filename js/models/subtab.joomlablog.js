...
(function($){
    wxApp.JoomlaBlogSubTab = wxApp.SubTab.extend({
        default_icon_id: 5,
        allowedLayouts: ['list'],
        typeDescription: 'Joomla Menu Item',
        validateFeed: false,
        ...
        defaults: function() {
            return _.extend( {}, wxApp.SubTab.prototype.defaults(), {
                ...
                helpBody:   '<p><b>Adding Joomla content to your app</b></p>' +
                    ...
                    '<p>Add Joomla article content to your app via an existing menu item.  The app will display content according to the &ldquo;ordering&rdquo; and content source(s) specified for the menu item.</p>' +                    '<p><b>Joomla Categories</b></p>'+

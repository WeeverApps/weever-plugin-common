describe('K2Proximity SubTab', function() {
    beforeEach(function() {
        var model = new wxApp.K2ProximitySubTab();
        this.model = model;
    ...
    it('should have default type of K2Proximity', function() {
        expect( this.model.get('type') ).toEqual('K2Proximity');
    });

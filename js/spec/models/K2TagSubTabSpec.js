describe('K2Tag SubTab', function() {
    beforeEach(function() {
        var model = new wxApp.K2TagSubTab();
        this.model = model;
	...
	it('should have default title of Blog', function() {
		expect( this.model.get('title') ).toEqual('Tag');
	});

    it('should have default type of K2Tag', function() {
        expect( this.model.get('type') ).toEqual('K2Tag');
    });

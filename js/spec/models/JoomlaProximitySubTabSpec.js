describe('JoomlaProximity SubTab', function() {
    beforeEach(function() {
        var model = new wxApp.JoomlaProximitySubTab();
        this.model = model;
    ...
    it('should have default type of JoomlaProximity', function() {
        expect( this.model.get('type') ).toEqual('JoomlaProximity');
    });

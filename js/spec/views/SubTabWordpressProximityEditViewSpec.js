describe('SubTabWordpressProximityEditView', function() {
    beforeEach(function() {
        ...
        loadFixtures('subtab.wordpressproximity.edit.tpl.html', 'feedsample.tpl.html');
    ...
    //     expect( this.wordpressProximityView.getFeedSample.calls.mostRecent().args[0].getConfig().url ).toEqual( this.wordpressProximityView.$('.wx-add-wordpress-proximity-select option:first').val() );
    // });

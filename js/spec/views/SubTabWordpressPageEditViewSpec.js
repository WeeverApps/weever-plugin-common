describe('SubTabWordpressPageEditView', function() {
    beforeEach(function() {
        ...
        loadFixtures('subtab.wordpresspage.edit.tpl.html', 'feedsample.tpl.html');
    ...
    //     expect( this.wordpressPageView.getFeedSample.calls.mostRecent().args[0].getConfig().url ).toEqual( this.wordpressPageView.$('.wx-add-wordpress-page-select option:first').val() );
    // });

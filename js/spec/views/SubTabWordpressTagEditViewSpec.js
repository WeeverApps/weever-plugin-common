describe('SubTabWordpressTagEditView', function() {
    beforeEach(function() {
        ...
        loadFixtures('subtab.wordpresstag.edit.tpl.html', 'feedsample.tpl.html');
    ...
    //     expect( this.wordpressTagView.getFeedSample.calls.mostRecent().args[0].getConfig().url ).toEqual( this.wordpressTagView.$('.wx-add-wordpress-tag-select option:first').val() );
    // });

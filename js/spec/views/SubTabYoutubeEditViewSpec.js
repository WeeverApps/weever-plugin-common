describe('SubTabYoutubeEditView', function() {
    beforeEach(function() {
        ...
        loadFixtures('subtab.youtube.edit.tpl.html', 'feedsample.tpl.html');
    ...
    //     expect( this.youtubeView.getFeedSample.calls.mostRecent().args[0].getConfig().url ).toEqual('http://youtube.com/pres201');
    // });
    ...
    //     this.youtubeView.$el.find('.wx-next-button').click();
    //     expect( this.youtubeView.getFeedSample.calls.mostRecent().args[0].getConfig().url ).toEqual('http://youtube.com/playlist?list=12345');
    // });

describe('SubTabFlickrEditView', function() {
    beforeEach(function() {
        ...
        loadFixtures('subtab.flickr.edit.tpl.html', 'feedsample.tpl.html');
    ...
    it('should add flickr photostream url to the call to validate the feed', function() {
        ...
        expect( this.flickrView.getFeedSample.calls.mostRecent().args[0].getConfig().url ).toEqual('http://flickr.com/photos/74346189@N05');
    });

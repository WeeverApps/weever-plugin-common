describe('SubTabgoogleCalendarEditView', function() {
    beforeEach(function() {
        ...
        loadFixtures('subtab.googlecalendar.edit.tpl.html', 'feedsample.tpl.html');
	...
	it('should add google e-mail to the call to validate the feed', function() {
		...
		expect( this.googleCalendarView.getFeedSample.calls.mostRecent().args[0].getConfig().calendar_id ).toEqual('abc123@group.calendar.google.com');
	});

describe('SubTabWordpressMapEditView', function() {
    beforeEach(function() {
        ...
        loadFixtures('subtab.wordpressmap.edit.tpl.html', 'feedsample.tpl.html');
    ...
    //     expect( this.wordpressMapView.getFeedSample.calls.mostRecent().args[0].getConfig().url ).toEqual( this.wordpressMapView.$('.wx-add-wordpress-map-select option:first').val() );
    // });

describe('SubTabWufooEditView', function() {
    beforeEach(function() {
        ...
        loadFixtures('subtab.wufoo.edit.tpl.html', 'feedsample.tpl.html');
    ...
    //     expect( this.wufooView.getFeedSample.calls.mostRecent().args[0].getConfig().url ).toEqual('https://USERNAME.wufoo.com/');
    //     expect( this.wufooView.getFeedSample.calls.mostRecent().args[0].getConfig().apikey ).toEqual('XXXX-XXXX-XXXX-XXXX');
    // });

describe('SubTabtwitterEditView', function() {
    beforeEach(function() {
        ...
        loadFixtures('subtab.twitter.edit.tpl.html', 'feedsample.tpl.html');
    ...
    it('should add twitter screen name to the call to validate the feed', function() {
        ...
        expect( this.twitterView.getFeedSample.calls.mostRecent().args[0].getConfig().screen_name ).toEqual('@brianhogg');
    });
    ...
    it('should add twitter hashtag to the call to validate the feed', function() {
        ...
        this.twitterView.$el.find('.wx-next-button').click();
        expect( this.twitterView.getFeedSample.calls.mostRecent().args[0].getConfig().q ).toEqual('#test');
    });
    ...
    it('should add twitter search term to the call to validate the feed', function() {
        ...
        this.twitterView.$el.find('.wx-next-button').click();
        expect( this.twitterView.getFeedSample.calls.mostRecent().args[0].getConfig().q ).toEqual('weever apps :)');
    });
